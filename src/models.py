...
def build_or_load_gen_model(args, load_model=True):
    ...
    # tokenizer_path = os.path.abspath(os.path.join(current_dir, '..', 'models/roberta_base/'))
    tokenizer_path = os.path.abspath(os.path.join(current_dir, '..', 'models/codet5_base/'))   # codet5_base + CCT5 classifier
